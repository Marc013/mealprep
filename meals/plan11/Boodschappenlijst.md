# Boodschappenlijst (plan 11)

Uitgangspunt:
- Totaal voor 7 dagen
- Verdeling: 4 trainingsdagen + 3 rustdagen
- Shakes en fruit vast (2 shakes per dag)
...
| Wortel                                         |                320 g |
| Champignons                                    |                840 g |
| Jumbo Kokosmelk Romig                          |                245 g |
| Limoensap                                      |                 60 g |
| Witte rijst (droog)                            |                680 g |
| 100% pindakaas naturel                         |                230 g |
| Kikkoman Natuurlijk Gebrouwen Sojasaus - Jumbo |                 64 g |
| Conimex Kruidenmix voor Nasi Speciaal          |                 78 g |
| Olijfolie Extra Vierge                         |                 39 g |
| Zout                                           |           naar smaak |
| Zwarte peper                                   |           naar smaak |
| Extra kurkuma                                  |           naar smaak |
...
| Ingrediënt                                   | Weektotaal (7 dagen) |
| :------------------------------------------- | -------------------: |
| Geen verplichte Lidl-producten in dit schema |                  0 g |
